...
print(f"DDP {ddp} - Device Type - {device_type}")
...
for step in range(max_steps):
    ...
    if master_process:
        print(f"step {step:5d} | loss: {loss_accum.item():.6f} | lr {lr:.4e} | norm: {norm:.4f} | dt: {dt*1000:.2f}ms | tok/sec: {tokens_per_sec:.2f} | tokens: {tokens_processed}")
        with open(log_file, "a") as f:
